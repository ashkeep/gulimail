...
public class AttrGroupController {
    ...
    public Resp<AttrGroupWithAttrsVo> attrGroupAttrs(@PathVariable("attrGroupId")
                                                     Long attrGroupId){
    ...
    public Resp<PageVo> getCatelogAttrGroups(QueryCondition queryCondition,@PathVariable("catId") Long catId){
